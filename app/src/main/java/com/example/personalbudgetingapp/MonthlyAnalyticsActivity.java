...
public class MonthlyAnalyticsActivity extends AppCompatActivity {
    ...
    private TextView analyticsEducationAmount, analyticsCharityAmount, analyticsApparelAmount, analyticsHealthAmount;
    private TextView analyticsPersonalExpensesAmount, analyticsOtherAmount;

    private RelativeLayout linearLayoutTransport, linearLayoutFood, linearLayoutFoodHouse, linearLayoutEntertainment;
    private RelativeLayout linearLayoutEducation, linearLayoutCharity, linearLayoutApparel, linearLayoutHealth;
    private RelativeLayout linearLayoutPersonalExp, linearLayoutOther;

    private TextView progress_ratio_transport, progress_ratio_food, progress_ratio_house, progress_ratio_ent, progress_ratio_edu;
    private TextView progress_ratio_cha, progress_ratio_app, progress_ratio_hea, progress_ratio_per, progress_ratio_oth;

    private ImageView status_Image_transport, status_Image_food, status_Image_house, status_Image_ent, status_Image_edu;
    private ImageView status_Image_cha, status_Image_app, status_Image_hea, status_Image_per, status_Image_oth;
